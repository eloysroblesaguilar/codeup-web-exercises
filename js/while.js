...
random number between 50 and 100 representing the amount of cones to sell before you start your loop.
...
console.log("I need to sell my cones! I still have " + allCones + " left.");

do {
    var wantedCones = Math.floor(Math.random() * 5) + 1;
    console.log("Customer wants " + wantedCones + " cone(s).");
    if (allCones >= wantedCones) {
        allCones -= wantedCones;
        console.log(wantedCones + " cone(s) sold. I now have " + allCones + " left.");
    } else {
        console.log("Sorry I cant sell you " + wantedCones + " cone(s)! I only have " + allCones);
    }
} while (allCones > 0 )
